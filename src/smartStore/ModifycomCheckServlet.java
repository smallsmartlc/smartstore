...
@WebServlet("/modifycomCheck.jsp") 
public class ModifycomCheckServlet extends HttpServlet {
...
//		 Create a new file upload handler 创建上传对象
		...
		String imgsrc = "img/comimg/"+ map.get("newimg");
		String systemPath = this.getServletContext().getRealPath("");
		System.out.println(comKey + comName + sellerName + price + introduce + imgsrc );
		ComBean upLoader = new ComBean();
		int res = -1;
		if(upLoader.modifyCom(comKey, comName, sellerName, price,introduce,imgsrc,systemPath)){
			res = 1;
		}
